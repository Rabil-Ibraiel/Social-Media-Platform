        ...
        axios.get(`${baseUrl}/posts/${id}`).then((res) => {
            ...
            <div class="card shadow" style="background-color: var(--dark-blue)">
                    <div class="card-header">
                        ...
                        <b style="color: var(--light-blue)">@${response.author.username}</b>
                    </div>
                    <div class="card-body" >
                    <p style="color: var(--light)" class="card-text">${response.body}</p>
                    <img class="w-100" src="${response.image}">

                    <h6 style="color: var(--light);" class="mt-1">${response.created_at}</h6>
                    ...
                    <div>
                        ...
                        <span style="color: var(--light)">(${response.comments_count}) comments</span>
                    </div>
        ...
        axios.get(`${baseUrl}/posts/${id}`).then((res) => {
            ...
            if (comments.length > 0) {
                comments.forEach(item => {
                    ...
                    commentsContent += `
                    <div class="p-3 rounded my-2" style="background-color: var(--blue)">
                                ...
                                <!-- Comment body-->
                                <div style="margin: 10px 0 0 5px; width: fit-content">
                                    <span style="color: var(--light)">${item.body}</span>
                                </div>
                                <!-- // Comment body // -->
