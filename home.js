...
let content = "";
    ...
    response.forEach((item) => {
        ...
        <button class="btn btn-outline-secondary" onclick="editPost('${encodeURIComponent(JSON.stringify(item))}')" data-bs-toggle="modal" data-bs-target="#create-post-modal" style="float: right; border-radius: 5px; border: none">Edit</button>
        ...
        <div class="card shadow">
            ...
            <div>${editBtnContent}</div>
                ...
                <h6 style="color: rgba(59, 57, 57, 0.7);" class="mt-1">${item.created_at}</h6>
